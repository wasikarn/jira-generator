...
- [ ] **กระชับ** - ไม่มีคำฟุ่มเฟือย ตัดคำที่ไม่จำเป็น
- [ ] **ชัดเจน** - ไม่คลุมเครือ ไม่ใช้ "ควรจะ", "น่าจะ"
- [ ] **ทับศัพท์** - ใช้คำ technical ภาษาอังกฤษ
- [ ] **เป็นกันเอง** - คุยกับทีม casual ไม่ทางการ

### Editing Existing Content

- [ ] **รักษา core message** - ไม่เปลี่ยนวัตถุประสงค์เดิม
- [ ] **ปรับแค่ภาษา/flow** - ไม่เปลี่ยน meaning
- [ ] **ถามก่อนแก้** - ถ้าไม่แน่ใจว่ากระทบความหมาย
